        ...
        <View style={styles.centerWrapper}>
          ...
          >
            <View style={styles.logoCircle}>
              <Ionicons name="settings-outline" size={28} color={COLORS.textLight} />
            </View>

            <Text style={styles.brand}>Criar conta na ÓRBITA</Text>

            <Text style={styles.title}>Comece sua jornada</Text>
            <Text style={styles.subtitle}>
              Crie sua conta para desbloquear missões, XP e recomendações da IA.
            </Text>
            ...
            >
              <Text style={styles.footerText}>
                Já tem conta?{" "}
                <Text style={styles.footerHighlight}>Voltar para login</Text>
              </Text>
            </TouchableOpacity>
          </Animated.View>
        </View>
